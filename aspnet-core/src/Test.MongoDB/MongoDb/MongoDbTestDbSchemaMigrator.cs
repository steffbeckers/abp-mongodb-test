...
{
    public class MongoDbTestDbSchemaMigrator : ITestDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbTestDbSchemaMigrator(IServiceProvider serviceProvider)
        {
